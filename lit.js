...
class BwJobList extends LitElement {
  ...
  connectedCallback() {
    super.connectedCallback();
    this.id = `bw-joblist-${BwJobList.instanceCounter++}`;
  }
      ...
      case "money":
        return html`<svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" style="max-width:${this.size}">
          ...
          <path
            fill-rule="evenodd"
            clip-rule="evenodd"
            d="M7.4171 6.86667H16.5829C16.5829 6.86667 23 11.9609 23 17.9058C23 21.3011 20.2481 23 18.4169 23H5.58313C3.75955 23 1 21.3012 1 17.9058C1 11.9609 7.4171 6.86667 7.4171 6.86667ZM12.9158 20.0278V18.6682C14.3206 18.4195 15.1635 17.6061 15.1634 16.3907C15.1634 15.2541 14.4836 14.6313 12.9057 14.3246L11.9599 14.1387C11.0393 13.9482 10.6655 13.6995 10.6655 13.2509C10.6655 12.6978 11.2376 12.3446 12.0302 12.3446C12.8229 12.3446 13.4 12.7279 13.4777 13.302L15.0104 13.3018C14.9704 12.2491 14.1449 11.4659 12.9057 11.2103V9.83914H11.0745V11.2082C9.80511 11.4708 9.00733 12.2703 9.00733 13.3788C9.00733 14.4874 9.70974 15.1776 11.1397 15.4542L12.1608 15.6564C13.1241 15.8561 13.5153 16.1211 13.5153 16.5859C13.5153 17.132 12.9108 17.5154 12.0579 17.5154C11.1322 17.5154 10.4924 17.1366 10.4147 16.5486H8.82675C8.88692 17.6688 9.73474 18.4403 11.0844 18.6727L11.0846 20.0278H12.9158Z"
            fill="${this.fill}"
          />
          ${clipPathDef}
        </svg>`;
